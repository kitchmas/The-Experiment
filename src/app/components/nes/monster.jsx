        ...
        return (
            <div>
                <div className="monster-bars">
                    ...
                    <progress className={this.props.stamina > 94 ? "nes-progress is-warning critical-hit" :"nes-progress is-warning"} value={this.props.stamina} max={this.props.maxStamina}></progress>
                </div>
